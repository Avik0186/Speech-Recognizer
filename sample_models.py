...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for layer_num in range(recur_layers):
        gru_rnn = GRU(units, return_sequences=True, implementation=2,
                      name='rnn'+str(layer_num))(input_from_prev_layer)
        # Add batch normalization 
        bn_rnn = BatchNormalization(name='rnn_bn'+str(layer_num))(gru_rnn)
...
def final_model(input_dim, units, recur_layers=2, output_dim=29):
    ...
    # Adding a 1-D Convolutional Neural Network
    conv_1d = Conv1D(filters, kernel_size, 
                     strides=conv_stride, 
                     padding=conv_border_mode,
                     activation='relu',
    ...
    for layer in range(0, recur_layers):
        ...
        gru_rnn = GRU(units, return_sequences=True, implementation=2, dropout=0.4, name='rnn'+str(layer))(input_from_prev_layer)
        # Add batch normalization 
